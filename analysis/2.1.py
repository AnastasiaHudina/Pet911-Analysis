...
def create_mean_comments_chart(success_stats, display_name):
    ...
    plt.tight_layout()
    plt.savefig(f'mean_comments_{display_name.replace(" ", "_")}.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def create_success_rate_by_comments_chart(df_analysis, display_name, success_description):
    ...
    plt.savefig(f'success_rate_by_comments_{display_name.replace(" ", "_")}.png', dpi=300, bbox_inches='tight')
    plt.close()
